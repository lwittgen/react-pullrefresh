...
var PullRefresh = function (_Component) {
  ...
  (0, _createClass3.default)(PullRefresh, [{
    ...
    value: function onMove(evt) {
      ...
      if (this._pullStartY !== undefined) {
        if (!this._isPulling) {
          var pullX = evt.nativeEvent.touches ? evt.nativeEvent.touches[0].pageX : evt.pageX;
          var pullY = evt.nativeEvent.touches ? evt.nativeEvent.touches[0].pageY : evt.pageY;
    ...
    value: function render() {
      var _props = this.props,
          ...
          as = _props.as,
          onPullStart = _props.onPullStart,
          onPullEnd = _props.onPullEnd,
          distanceToPull = _props.distanceToPull,
          children = _props.children,
          props = (0, _objectWithoutProperties3.default)(_props, ['zIndex', 'render', 'bgColor', 'color', 'onRefresh', 'disabled', 'as', 'onPullStart', 'onPullEnd', 'distanceToPull', 'children']);
...
PullRefresh.propTypes = {
  ...
  onPullStart: _propTypes2.default.func,
  onPullEnd: _propTypes2.default.func,
  distanceToPull: _propTypes2.default.number
};
...
PullRefresh.defaultProps = {
  ...
  zIndex: undefined,
  onPullStart: function onPullStart() {},
